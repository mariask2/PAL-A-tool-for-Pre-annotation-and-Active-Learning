...
def select_new_data(properties, project_path):
    ...
    to_select_X, new_unlabelled_x, to_select_text, new_sentences_unlabelled, predicted_for_selected = classify_and_select.get_new_data(X_labelled_np, X_unlabelled_np, y_labelled_np, text_vector_labelled_np, text_vector_unlabelled_np, label_dict, properties.minority_classes, properties.nr_of_samples, properties.maximum_samples_to_search_among, properties.outside_class, properties.beginning_prefix, properties.inside_prefix, properties.inactive_learning, properties.max_iterations, properties.prefer_predicted_chunks)
